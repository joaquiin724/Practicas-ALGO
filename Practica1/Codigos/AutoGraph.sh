...
plot "Resultados/Salida1$name.txt" using 1:2 with linespoints title "int", \
     "Resultados/Salida2$name.txt" using 1:2 with linespoints title "float", \
     "Resultados/Salida3$name.txt" using 1:2 with linespoints title "double" 
