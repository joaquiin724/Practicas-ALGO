...
for ((i=12308; i<=202308 ; i+=40000)) do
    printf "$i \t" >> Grafica$name/SalidaTest4$name.txt
    ./Ejecutables/$name $i 4 >> Grafica$name/SalidaTest4$name.txt            
...
# Establece la leyenda, donde 
    ...
    # with linespoints indica que se dibujarán líneas uniendo los puntos
    # segundo "" indica el nombre que se le dará a la serie
plot "Grafica$name/SalidaTest4$name.txt" using 1:2 with linespoints title "string"
